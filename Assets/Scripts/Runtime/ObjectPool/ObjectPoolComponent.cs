...
namespace UnityGameFramework.Runtime.ObjectPool
{
    /// <summary>
    /// 对象池组件
    /// </summary>
    ...
    public class ObjectPoolComponent:GameFrameworkComponent
    {
        ...
        {
            base.Awake();
            this.m_ObjectPoolManager = GameFrameworkEntry.GetModule<IObjectPoolManager>();
        ...
        public int Count
        {
            get { return this.m_ObjectPoolManager.Count; }
        }
        /// <summary>
        /// 检查是否存在对象池
        /// </summary>
        ...
        {
            return this.m_ObjectPoolManager.HasObjectPool<T>();
        }
        /// <summary>
        /// 检查是否存在对象池。
        /// </summary>
