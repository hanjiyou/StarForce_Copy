...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class BaseComponent:GameFrameworkComponent
    {
        ...
        [SerializeField]
        private bool m_EditorResourceMode = true;//默认开启编辑器资源模式
        [SerializeField]
        ...
        public void PauseGame()
        {
            ...
            this.m_GameSpeedBeforePause = GameSpeed;
            GameSpeed = 0f;
        ...
        public void ResumeGame()
        {
            ...
            GameSpeed = this.m_GameSpeedBeforePause;
        }
        /// <summary>
        /// 重置为正常游戏速度
        /// </summary>
        ...
        {
            if (string.IsNullOrEmpty(this.m_JsonHelperTypeName))
            {
                return;
            }
