...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class DataNodeComponent:GameFrameworkComponent
    {
        ...
        {
            base.Awake();
            this.m_DataNodeManager = GameFrameworkEntry.GetModule<IDataNodeManager>();
            if (this.m_DataNodeManager == null)
            {
        ...
        {
            get { return this.m_DataNodeManager.Root; }
        }
        /// <summary>
        /// 根据类型获取数据节点的数据
        /// </summary>
        ...
        {
            return this.m_DataNodeManager.GetData<T>(path);
        }
        /// <summary>
        /// 获取数据节点的数据
        /// </summary>
        ...
        {
            return this.m_DataNodeManager.GetData(path);
        }
        /// <summary>
        /// 根据类型获取数据结点的数据
        /// </summary>
        ...
        {
            return this.m_DataNodeManager.GetData<T>(path, node);
        }
        /// <summary>
        /// 获取数据结点的数据
        /// </summary>
        ...
        {
            return this.m_DataNodeManager.GetData(path, node);
        }
        /// <summary>
        /// 设置数据结点的数据
        /// </summary>
        ...
        {
            this.m_DataNodeManager.SetData(path,data);
        }
        /// <summary>
        /// 设置数据结点的数据。
        /// </summary>
