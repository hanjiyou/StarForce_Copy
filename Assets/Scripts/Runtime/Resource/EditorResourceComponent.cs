...
#pragma warning restore 0067, 0414
        private void Awake()
        {
            ...
            this.m_LoadAssetInfos=new LinkedList<LoadAssetInfo>();
            this.m_LoadSceneInfos=new LinkedList<LoadSceneInfo>();
            this.m_UnloadSceneInfos=new LinkedList<UnloadSceneInfo>();
